...
const AboutSection = ({ curriculoType = "front" }) => {
  ...
  const certificates = [
    {
      ...
      url: "/" + encodeURIComponent("Seja full stack com react.pdf"),
      platform: "Udemy",
    ...
    },
    {
      ...
      url: "/" + encodeURIComponent("Curso web api asp .net.pdf"),
      platform: "Udemy",
    ...
    },
    {
      ...
      url: "/" + encodeURIComponent("next.js e react curso completo.pdf"),
      platform: "Udemy",
    ...
    },
    {
      ...
      url: "/" + encodeURIComponent("react do zero a maestria.pdf"),
      platform: "Udemy",
    ...
    },
    {
      ...
      url: "/" + encodeURIComponent("certificação amazon aws certified cloud.pdf"),
  ...
  return (
    <section className="py-32 relative overflow-hidden bg-white dark:bg-slate-900 transition-colors duration-300" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-24">
          ...
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary-50/50 dark:bg-primary-900/20 rounded-bl-full"></div>
            ...
            <div className="relative z-10 flex items-start gap-6 mb-8">
              ...
              <div>
                <h3 className="text-4xl font-black text-light-900 dark:text-slate-100 mb-2">Formação Acadêmica</h3>
                <p className="text-light-500 dark:text-slate-400 text-sm font-semibold">Educação e Conhecimento</p>
              </div>
            </div>

            <div className="relative z-10 space-y-4">
              <h4 className="text-2xl font-black text-light-900 dark:text-slate-100 mb-3">Análise e Desenvolvimento de Sistemas</h4>
              <p className="text-primary-600 dark:text-primary-400 text-xl font-black mb-2">Universidade Positivo (UP)</p>
              <p className="text-light-500 dark:text-slate-400 mb-4 font-black">2023 – 2025</p>
              <p className="text-light-600 dark:text-slate-300 leading-relaxed text-lg font-medium">
          ...
          >
            ...
            <div className="relative z-10 flex items-start gap-6 mb-8">
              ...
              <div>
                <h3 className="text-4xl font-black text-light-900 dark:text-slate-100 mb-2">Experiência Prática</h3>
                <p className="text-light-500 dark:text-slate-400 text-sm font-semibold">Trabalho e Projetos</p>
              </div>
            </div>
            ...
            <div className="relative z-10 space-y-6">
              <div className="flex items-baseline gap-4 mb-4">
                ...
                <div className="text-xl text-light-600 dark:text-slate-300 font-black">Anos de Experiência</div>
              </div>
              <p className="text-light-600 dark:text-slate-300 leading-relaxed text-lg font-medium">
        ...
        >
          <div className="text-center mb-16">
            <h3 className="text-4xl lg:text-5xl font-black text-light-900 dark:text-slate-100 mb-4">Minhas Habilidades</h3>
            <p className="text-xl text-light-600 dark:text-slate-300 font-medium">Competências técnicas e interpessoais</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className="group bg-white dark:bg-slate-800 border-2 border-light-300 dark:border-slate-600 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500"
              >
                ...
                <h4 className="text-xl font-black text-light-900 dark:text-slate-100 mb-3 group-hover:text-primary-600 transition-colors duration-300">
                  {skill.title}
                </h4>
                <p className="text-light-600 dark:text-slate-300 leading-relaxed font-medium">
                  {skill.description}
                </p>
              </motion.div>
            ))}
        ...
        >
          <div className="text-center mb-20">
            ...
            <h3 className="text-5xl lg:text-6xl font-black text-light-900 dark:text-slate-100 mb-4">Diplomas & Certificados</h3>
            <p className="text-xl text-light-600 dark:text-slate-300 font-medium">Cursos e certificações que validam meu conhecimento</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certificates.map((cert, index) => (
              <motion.a
                ...
                className="group relative bg-white dark:bg-slate-800 border-2 border-light-300 dark:border-slate-600 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden cursor-pointer"
              >
                <div className="relative z-10 flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-lg font-black text-light-900 dark:text-slate-100 group-hover:text-primary-600 transition-colors duration-300 mb-2 line-clamp-2">
                      {cert.title}
                    </h4>
                    <p className="text-light-500 dark:text-slate-400 text-sm font-semibold mb-1">{cert.platform}</p>
